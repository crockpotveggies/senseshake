# DAQHAT-01 hardening and prototype preparation
...
**Disposition: ready to prepare a small DAQHAT-01 prototype fabrication package.**
The post-rename full run `20260926T013300Z-5e8c2946` passed all 22 stages: 43 hardware
regressions, 185 software tests, 102 SPICE cases and zero native ERC/DRC/unrouted
findings. Clean replay matches all 7,522 copper objects, including 11 microvias.
Thirteen lab-safety cases are covered across Windows/Linux (platform-specific
...
The [hardware verification record](../hw/boards/groundlark-daqhat-01/verification.json)
...
1. Freeze the tested DAQHAT-01 revision and exact assembly: Pi 4, specified riser and
...
- **Power:** verify both power-up/down orders, rail ramps, partial-power isolation,
  inrush and load transients. Supply J83 at 3.35 V Â±0.5%; operating module rail
  must stay 3.201â€“3.399 V, with a measured total hot loop at most 30 mÎ© within
...
The deferred A2/Coldfoot board is not the recommended first DAQHAT-01 fabrication release.
