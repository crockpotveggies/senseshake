> DAQHAT-01 supersedes the GPIO/ribbon and external JTAG assembly described below.
...
traceability, not as evidence about the current DAQHAT-01. Current evidence has 6,444 copper
...
The [engineering report](../hw/boards/groundlark-daqhat-01/engineering.json)
...
The [verification record](../hw/boards/groundlark-daqhat-01/verification.json)
...
1. **Power and isolation:** use a current-limited source; measure J83 and module
   ...
   rail limit.
2. **Fit:** assemble Pi → riser → DAQHAT-01 → Trenz with the intended cooler and four
