...
The FPGA carrier has ten additional bounded checks in `trenz/`, run with
`python3 tools/simulate_trenz.py`. These cover DC input budgets, detection of
...
Run `python3 tools/simulate.py` with ngspice. It writes all 27 circuit decks,
