...
protected=['hw/elec/hat.ato','hw/elec/field_head.ato','hw/elec/parts.ato','hw/layout.json',
 'hw/boards/groundlark-hat/groundlark-hat.kicad_pcb','hw/boards/groundlark-field-head/groundlark-field-head.kicad_pcb']
...
for pattern in ['hw/libraries/Groundlark.pretty/*.kicad_mod','sw/pi/groundlark/*.py','sw/tests/*.py','sw/ui/assets/*','sw/ui/main.py','docs/geophone-input.md','hw/elec/geophone_parts.ato','hw/elec/host_link_parts.ato','hw/elec/symbols/LINK*.kicad_sym','sw/fpga/rtl/*.sv','sw/fpga/tests/*.sv','sw/fpga/*.py','sw/fpga/*.xdc','sw/fpga/*.tcl','sw/fpga/verification/*','sw/tools/fpga.py','sw/pi/deploy/*.cfg','sw/pi/deploy/*.dts','docs/fpga-host-link*.md','hw/simulation/host-link/*','hw/elec/symbols/GEO*.kicad_sym','hw/elec/Connector_Phoenix_MC*.kicad_mod','hw/elec/Package_SO__TSSOP*.kicad_mod','hw/elec/Package_TO_SOT_SMD*.kicad_mod','docs/geophone-input.md','hw/simulation/geophone/*','hw/tools/*.py','hw/tests/*.py','docs/trenz-*.csv','hw/elec/TZ_*.kicad_mod','hw/elec/symbols/TZ*.kicad_sym','hw/boards/groundlark-daqhat-01/*','hw/simulation/trenz/*','hw/models/trenz/*','hw/models/FFC_*.wrl','hw/models/Pi4_stack_concept.wrl','environment/lab.py','docs/stack-assembly.md','docs/pre-fab-acquisition-stress.json','hw/simulation/geophone-review/*','hw/models/DAQHAT_01_service_envelopes.wrl']:
