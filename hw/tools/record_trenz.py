...
for pattern in ['hw/tools/*.py','hw/tests/*.py','docs/trenz-*.csv','docs/t1-engineering-closure.md','docs/sensor-development-plan.md','hw/elec/TZ_*.kicad_mod','hw/elec/symbols/TZ*.kicad_sym','hw/boards/shakesense-trenz-hat/*','hw/simulation/trenz/*','hw/models/trenz/*','hw/models/FFC_*.wrl','hw/models/Pi4_stack_concept.wrl','environment/lab.py']:
...
j['trenz_status']='T1 Pi-outline 8-layer HDI GPIO prototype; native ERC/DRC/connectivity and 15 portable stages pass; calculated RF/power/clearance checks, physical qualification and FPGA bitstream pending'
