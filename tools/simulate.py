...
See simulation/README.md for model scope, assumptions and acceptance criteria.
"""
from pathlib import Path
import subprocess,json,re,itertools,math
ROOT=Path(__file__).resolve().parents[1]; OUT=ROOT/'simulation';OUT.mkdir(exist_ok=True)
results=[]
