...
ROOT=Path(__file__).resolve().parents[1];E=ROOT/'elec'
...
parts=json.loads((ROOT/'layout.json').read_text())['shakesense-hat']['parts']
...
(ROOT/'layout-trenz.json').write_text(json.dumps({'shakesense-trenz-hat':{'target':'trenz_hat','size':[85,56],'parts':parts}},indent=2))
