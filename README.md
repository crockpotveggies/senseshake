# ShakeSense A2 — atopile sensor/Coldfoot HAT
...
with [carrier 3D](hardware/shakesense-trenz-hat/3d.png) and
[three-board stack concept](hardware/shakesense-trenz-hat/pi-trenz-stack-concept.png).
...
- [Atopile project](ato.yaml), [HAT circuit](elec/hat.ato), [field circuit](elec/field_head.ato), [parts](elec/parts.ato).
- [KiCad HAT PCB](hardware/shakesense-hat/shakesense-hat.kicad_pcb) and [review schematic](hardware/shakesense-hat/shakesense-hat.kicad_sch).
- [KiCad field PCB](hardware/shakesense-field-head/shakesense-field-head.kicad_pcb).
- [HAT 3D](hardware/shakesense-hat/3d.png), [field-head 3D](hardware/shakesense-field-head/3d.png), [infrasound option fitted](hardware/shakesense-field-head/3d-infrasound-option.png).
- [HAT BOM](hardware/shakesense-hat/bom.csv), [field BOM](hardware/shakesense-field-head/bom.csv).
...
- [Simulation scope](simulation/README.md), [rebuilding](docs/build.md).
- [Artix-7 200T module shortlist and FPGA carrier requirements](docs/fpga-options.md).

Electrical changes belong in `.ato` files. `layout.json` contains placement and
